      ...
      <div style={{ minHeight: '100vh', background: 'var(--zander-off-white)' }}>
        <nav style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            <a href="/settings" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', textDecoration: 'none', padding: '0.35rem 0.5rem', borderRadius: '8px', transition: 'background 0.2s' }}>
